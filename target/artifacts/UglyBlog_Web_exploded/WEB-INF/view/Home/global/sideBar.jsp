    ...
    <aside class="layui-card category-card">
        ...
        <div class="layui-card-body category-card-body">
            <ul class="category" id="category">
                <li><a href="<c:url value="/blogs/category/all"/>">全部文章</a></li>
                <c:forEach items="${categoryList}" var="category">
                    <li>
                        <a href="<c:url value="/blogs/category/${category.categoryId}/"/>">${category.categoryName}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
        ...
        <div class="layui-card-body">
            <ul class="article-card-list" id="hot-article-list">
                <c:forEach items="${hotArticles}" var="article">
                    <li><a href="/blogs/${article.articleId}">${article.articleTitle}</a></li>
                </c:forEach>
            </ul>
        </div>
    </aside>
